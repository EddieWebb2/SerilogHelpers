...
namespace SerilogHelpers.Infrustructure
{
    public interface ILoggingConfiguration
    {
        ...
        /// <summary>Used within Desktop apps to write to the Temp directory, When false will write to the application directory (used for services)</summary>
